...
25. **Side-Effects Check**: Verify lifecycle management of external APIs (TTS, Video, WebSockets). Ensure cleanup functions (!isCompleteRef) and prevent race conditions. Reference `viz-app/docs/GOLDEN_RULES.md`.
