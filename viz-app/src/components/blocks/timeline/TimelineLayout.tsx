...
export const TimelineLayout = ({ data, onUpdate, isEditable = true, onStepClick, activeStepIndex, getHighlightClass = () => '', stepIdPrefix = 'step' }: TimelineLayoutProps) => {
            ...
            <div ref={ref} className="relative max-w-7xl mx-auto pb-20">
                {data.map((item, index) => {
                    ...
                    return (
                        <div
                            key={index}
                            className={`flex justify-start pt-20 md:pt-44 md:gap-10 transition-all duration-200 p-4 group
                        ...
                        >
                            ...
                            <div className={`relative pl-4 pr-4 md:pl-8 flex-1 md:w-3/4 rounded-xl transition-all duration-200
                                ${isEditable ? 'hover:bg-slate-50 dark:hover:bg-white/5 border border-transparent hover:border-slate-200 dark:hover:border-white/10' : ''}
                ...
                <div
                    ...
                    className={`absolute md:left-12 left-12 top-0 overflow-hidden w-[2px] bg-[linear-gradient(to_bottom,${TIMELINE_CONSTANTS.VAR_GRADIENT})] from-transparent from-[0%] via-neutral-200 dark:via-neutral-700 to-transparent to-[99%] [mask-image:${TIMELINE_CONSTANTS.MASK_IMAGE}]`}
                >
                    <div
                        style={{
                            height: height + "px",
